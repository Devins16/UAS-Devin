<template>
    <div class="stopwatch-widget">
      ...
      <p>{{ formatTime }}</p>
      <div>
        <button @click="startStopwatch" :disabled="isRunning">Mulai</button>
        <button @click="stopStopwatch" :disabled="!isRunning">Berhenti</button>
        <button @click="resetStopwatch">Ulang</button>
      </div>
    </div>
  </template>
